export const ModalName = {
  ...
  SwiftConnect: 'swift-connect-modal',
  SwiftSend: 'swift-send-modal',
  SwiftDepositGas: 'swift-deposit-gas-modal',
  SwiftGasBalance: 'swift-gas-balance-modal',
  SwiftSpeedUp: 'swift-speed-up-modal',
