...
export enum ElementName {
  ...
  SwiftConnectButton = 'swift-connect-button',
  SwiftDisconnectButton = 'swift-disconnect-button',
  SwiftUploadButton = 'swift-upload-button',
  SwiftCancelButton = 'swift-cancel-button',
  SwiftContinueButton = 'swift-continue-button',
  SwiftSendButton = 'swift-send-button',
  SwiftSendPreviewButton = 'swift-send-preview-button',
  SwiftSendConfirmButton = 'swift-send-confirm-button',
  SwiftDepositGasButton = 'swift-deposit-gas-button',
  SwiftCopyAddressButton = 'swift-copy-address-button',
  SwiftConfirmDepositButton = 'swift-confirm-deposit-button',
